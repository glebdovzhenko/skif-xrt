...
class PgSurfacePlot(gl.GLViewWidget):
    def __init__(
        self, parent=None, devicePixelRatio=None, rotationMethod="euler", box=None
    ):
...
def surf3d(xdata, ydata, zdata, title=""):
    ...
    xgrid.scale(0.05 * (box[2][1] - box[2][0]), 0.05 * (box[1][1] - box[1][0]), 1.0)
    ygrid.scale(0.05 * (box[0][1] - box[0][0]), 0.05 * (box[2][1] - box[2][0]), 1.0)
    zgrid.scale(0.05 * (box[0][1] - box[0][0]), 0.05 * (box[1][1] - box[1][0]), 1.0)

    xgrid.rotate(90, 0, 1, 0)
    ygrid.rotate(90, 1, 0, 0)

    xgrid.translate(
        box[0][0], 0.5 * (box[1][1] + box[1][0]), 0.5 * (box[2][1] + box[2][0])
    )
    ygrid.translate(
        0.5 * (box[0][1] + box[0][0]), box[1][0], 0.5 * (box[2][1] + box[2][0])
    )
    zgrid.translate(
        0.5 * (box[0][1] + box[0][0]), 0.5 * (box[1][1] + box[1][0]), box[2][0]
    )
