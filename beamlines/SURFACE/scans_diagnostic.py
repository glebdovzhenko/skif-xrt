...
from diagnostic_branch import SURFACE_DIAGNOSTIC
...
def onept(bl: SURFACE_DIAGNOSTIC, plts: List):
    """"""
    bl.bm.eMin = bl.alignE * (1.0 - 0.5e-3)
    bl.bm.eMax = bl.alignE * (1.0 + 0.5e-3)
