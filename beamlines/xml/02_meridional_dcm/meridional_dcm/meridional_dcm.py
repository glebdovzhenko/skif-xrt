...
def build_beamline():
    ...
    beamLine.dcmC2 = roes.BentLaue2D(
        bl=beamLine,
        name=None,
        center=[25, 33189.355, 0],
        pitch=2.12095,
        roll=4.71238898038469,
        material=crystalSi01,
        alpha=0.6161012259539983,
        Rm=-10000.0,
        Rs=10000000000.0,
    ...
    beamLine.screenExit = rscreens.Screen(
        bl=beamLine,
        name=None,
        center=[25, 56000, 0])
...
def run_process(beamLine):
    ...
    screen01beamLocal02 = beamLine.screenExit.expose(
        beam=bentLaue2D02beamGlobal01)
    ...
    outDict = {
        ...
        'screen01beamLocal02': screen01beamLocal02}
    return outDict
...
def define_plots():
    ...
    plot13 = xrtplot.XYCPlot(
        beam=r"screen01beamLocal02",
        xaxis=xrtplot.XYCAxis(
            label=r"x",
            bins=512,
            ppb=1,
        ...
        aspect=r"auto",
        title=r"EXIT XZ",
        persistentName=r"dcm_30keV_exit_xz.npy")
    plots.append(plot13)
    ...
    plot14 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"EXIT FX",
        persistentName=r"dcm_30keV_exit_fx.npy")
    plots.append(plot14)
    ...
    plot15 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"EXIT FZ",
        persistentName=r"dcm_30keV_exit_fz.npy")
    plots.append(plot15)
    return plots
