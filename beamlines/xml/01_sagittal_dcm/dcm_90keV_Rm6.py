...
import numpy as np
import sys
sys.path.append(r"/nix/store/iwxbw4a8c4q0zjsmz3f6smcqwmvp1l85-python3.12-xrt-1.6.1/lib/python3.12/site-packages")
...
def define_plots():
    ...
    plot01 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"SOURCE XZ",
        persistentName=r"dcm_90keV_source_xz.npy")
    plots.append(plot01)
    ...
    plot06 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"FRONTEND XZ",
        persistentName=r"dcm_90keV_frontend_xz.npy")
    plots.append(plot06)
    ...
    plot07 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"C1 XZ",
        persistentName=r"dcm_90keV_c1_xz.npy")
    plots.append(plot07)
    ...
    plot10 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"C2 XZ",
        persistentName=r"dcm_90keV_c2_xz.npy")
    plots.append(plot10)
    ...
    plot02 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"SOURCE FX",
        persistentName=r"dcm_90keV_source_fx.npy")
    plots.append(plot02)
    ...
    plot05 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"FRONTEND FX",
        persistentName=r"dcm_90keV_frontend_fx.npy")
    plots.append(plot05)
    ...
    plot08 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"C1 FX",
        persistentName=r"dcm_90keV_c1_fx.npy")
    plots.append(plot08)
    ...
    plot11 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"C2 FX",
        persistentName=r"dcm_90keV_c2_fx.npy")
    plots.append(plot11)
    ...
    plot03 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"SOURCE FZ",
        persistentName=r"dcm_90keV_source_fz.npy")
    plots.append(plot03)
    ...
    plot04 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"FRONTEND FZ",
        persistentName=r"dcm_90keV_frontend_fz.npy")
    plots.append(plot04)
    ...
    plot09 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"C1 FZ",
        persistentName=r"dcm_90keV_c1_fz.npy")
    plots.append(plot09)
    ...
    plot12 = xrtplot.XYCPlot(
        ...
        aspect=r"auto",
        title=r"C2 FZ",
        persistentName=r"dcm_90keV_c2_fz.npy")
    plots.append(plot12)
    return plots
